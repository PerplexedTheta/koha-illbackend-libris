...
=item * B<partner_code> - categorycode for a patron category that lending
libraries are added to when data about them is fatched from Libris and they
are added to Koha.
